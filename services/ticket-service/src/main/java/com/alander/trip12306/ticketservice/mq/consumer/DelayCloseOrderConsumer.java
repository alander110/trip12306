...
import com.alander.trip12306.ticketservice.mq.event.DelayCloseOrderEvent;
...
import static com.alander.trip12306.ticketservice.common.constant.RedisKeyConstant.TRAIN_STATION_REMAINING_TICKET;
...
public class DelayCloseOrderConsumer implements RocketMQListener<MessageWrapper<DelayCloseOrderEvent>> {
    ...
    @Idempotent(
            uniqueKeyPrefix = "trip12306-ticket:delay_close_order:",
