...
import com.alander.trip12306.ticketservice.dto.req.TicketOrderItemQueryReqDTO;
import com.alander.trip12306.ticketservice.remote.dto.TicketOrderCreateRemoteReqDTO;
 ...
 * 车票订单远程服务调用
*/
@FeignClient(value = "trip12306-order-service", url = "${aggregation.remote-url:}")
